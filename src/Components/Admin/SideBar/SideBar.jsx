        ...
        <div className="d-flex flex-column flex-shrink-0 p-3 bg-body-tertiary" style={{ width: "280px" }}>
          ...
          <ul className="nav nav-pills flex-column mb-auto">
            <li className="nav-item">
              <Link onClick={() => setActive("Dashboard")} to="/admin" className={activeSection === 'Dashboard' ? 'nav-link link-body-emphasis active' : 'nav-link link-body-emphasis'} >
            ...
            <li>
              <Link to="/admin/sectionsetup" onClick={() => setActive("Secciones")} className={activeSection === 'Secciones' ? 'nav-link link-body-emphasis active' : 'nav-link link-body-emphasis'}>
                <svg className="bi pe-none me-2" width="16" height="16"><use href="#speedometer2" /></svg>

                Secciones

              </Link>
              {/* <a href="/admin/sectionsetup" className="nav-link link-body-emphasis">
                <svg className="bi pe-none me-2" width="16" height="16"><use href="#speedometer2" /></svg>
                Secciones
              </a> */}
            </li>
            <li>
              <Link data-section to="/admin/productsetup" onClick={() => setActive("Productos")} className={activeSection === 'Productos' ? 'nav-link link-body-emphasis active' : 'nav-link link-body-emphasis'} >
                <svg className="bi pe-none me-2" width="16" height="16"><use href="#grid" /></svg>

                Productos

              </Link>
              {/* <a href="/admin/productsetup" className="nav-link link-body-emphasis">
                <svg className="bi pe-none me-2" width="16" height="16"><use href="#speedometer2" /></svg>
                Productos
              </a> */}
            </li>
